...
public class Calendar_Activity extends Activity implements OnClickListener{
	
	private static final String tag = "MyCalendarActivity";

	private TextView currentMonth;
	private Button selectedDayMonthYearButton, pickTime;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		selectedDayMonthYearButton.setText("Selected Date: ");
	...
	public class GridCellAdapter extends BaseAdapter implements OnClickListener {
		...
		public void onClick(View view) {
			...
			selectedDayMonthYearButton.setText("Selected Date: " + date_month_year);
